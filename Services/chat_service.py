...
class chat_service:
    ...
    def obtener_chats_de_usuario(self, idU):
    ...
    def obtener_chat_detalle(self, idU, idChat):
        chats = chat_repositorio.obtener_chats_usuario(idU)
    ...
    def enviar_mensaje(self, id_chat, id_usuario, contenido):
        ...
        chat_repositorio.enviar_mensaje(id_chat, id_usuario, contenido)
        return chat_repositorio.ver_chat(id_chat), None, 201

    def crear_chat(self, idU, id_delegado, id_candidato, mensaje):
        ...
        Resultado = chat_repositorio.crear_chat_con_mensaje(id_delegado, id_candidato, idU, mensaje)  
    ...
    def eliminar_chat(idU, id_chat):
        ...
        chat_repositorio.eliminar_chat(id_chat)
